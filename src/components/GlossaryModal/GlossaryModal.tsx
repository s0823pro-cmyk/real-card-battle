...
const GLOSSARY_ITEMS: GlossaryEntry[] = [
  ...
  },
  {
    type: 'item',
    term: '不安',
    desc: '使用不可のカード。タイムライン上に置くと1秒を無駄に消費する。メンタルが低いとドローに混入する。戦闘終了後はデッキから除去される。',
  },
  {
    type: 'item',
    term: '呪い',
  ...
  },
  {
    type: 'item',
    term: '段取り',
    desc: '【準備】バッジを持つカードの直後に使ったカードに発動するボーナス。ダメージ・ブロック・回復が1.3倍になり、所要時間が-1秒される（preparationTimeCostがあるカードはそちらを使用）。宮大工の技で倍率を1.5倍/1.8倍に強化可能。',
  },
  {
    type: 'item',
    term: '準備バッジ',
