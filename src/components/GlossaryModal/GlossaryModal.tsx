...
const GLOSSARY_ITEMS: GlossaryEntry[] = [
  { type: 'heading', term: '基本システム' },
  {
    type: 'item',
    term: 'タイムバー',
    desc: 'そのターンに使える行動時間（秒）。基本は「5秒＋メンタル×0.3秒」に、ターンごとのボーナス秒が加算される（小数第1位まで）。最低3秒、メンタルが高いほど長くなる（最大メンタル10まで成長）。カードをタイムラインに置くと、カードのコスト分だけ時間が減る。',
  },
  {
    type: 'item',
    term: 'メンタル',
  ...
  },
  {
    type: 'item',
    term: '【消耗】',
    desc: '温存した状態で次のターンに使うと、使用後にデッキに戻らず「除外」されるマーク。強力な代わりに1戦限りのカードとして扱われる。温存しなければ通常どおり捨て札へ。',
  },
  {
    type: 'item',
    term: '【自傷】',
  ...
  { type: 'heading', term: '温存・段取り' },
  {
    type: 'item',
    term: '温存（行動）',
    desc: 'カードを敵やタイムバーではなく「温存エリア」にドロップし、次の自分のターンの開始時に手札へ戻す行動。最大2枚まで。温存した枚数×1.5秒、次ターンのタイムバー最大時間が減る（例：1枚で−1.5秒、2枚で−3秒）。',
  },
  {
    type: 'item',
    term: '温存ボーナス',
  ...
  },
  {
    type: 'item',
    term: '弱体（アイコン表示）',
    desc: '水色の下向き矢印のバッジ。付いている側は「与えるダメージが25％減少」する状態。数字は残りターン。プレイヤー・敵どちらにも付く。',
  },
  {
    type: 'item',
    term: '炎上（アイコン表示）',
  ...
  },
  {
    type: 'item',
    term: '炎上・火傷',
    desc: '画面で「炎上」と出ることが多い。ターン終了時にダメージを受けるなど、燃焼系のデバフ。残りターンやダメージ量は付与元（カード・敵行動）による。',
  },
  {
    type: 'item',
    term: '攻撃力ダウン',
