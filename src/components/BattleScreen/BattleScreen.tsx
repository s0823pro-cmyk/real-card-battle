...
import bgBattleCarpenterArea1 from '../../assets/backgrounds/bg_battle_carpenter_area1.jpg';
import bgBattleCarpenterArea2 from '../../assets/backgrounds/bg_battle_carpenter_area2.jpg';
import bgBattleCarpenterArea3 from '../../assets/backgrounds/bg_battle_carpenter_area3.jpg';
...
import bgBattleCookArea1 from '../../assets/backgrounds/bg_battle_cook_area1_v2.jpg';
import bgBattleCookArea2 from '../../assets/backgrounds/bg_battle_cook_area2_v2.jpg';
import bgBattleCookArea3 from '../../assets/backgrounds/bg_battle_cook_area3_v2.jpg';
...
import bgBattleUnemployedArea1 from '../../assets/backgrounds/bg_battle_unemployed_area1.jpg';
import bgBattleUnemployedArea2 from '../../assets/backgrounds/bg_battle_unemployed_area2.jpg';
import bgBattleUnemployedArea3 from '../../assets/backgrounds/bg_battle_unemployed_area3.jpg';
import bgBattleCourierArea1 from '../../assets/backgrounds/bg_battle_courier_area1.jpg';
import bgBattleCourierArea2 from '../../assets/backgrounds/bg_battle_courier_area2.jpg';
import bgBattleCourierArea3 from '../../assets/backgrounds/bg_battle_courier_area3.jpg';
...
const BattleScreen = ({
  ...
  const battleBackgroundSrc = useMemo(() => {
    ...
    if (jid === 'courier') {
      if (area === 1) return bgBattleCourierArea1;
      if (area === 2) return bgBattleCourierArea2;
      return bgBattleCourierArea3;
    }
  ...
  const onHandCardPointerMove = (event: ReactPointerEvent) => {
    ...
    const longPress = performance.now() - start.time > 150;
    ...
    if (handDrag.isDragging && handDrag.card) {
      ...
      if (finalTarget === 'enemy') {
        if (!enemyTargetCard) {
          ...
          if (result.played) {
            // eslint-disable-next-line react-hooks/purity
            lastCardPlayTimeRef.current = performance.now();
            playSe('card');
  ...
  }, [handDrag.isDragging, handDrag.dropTarget, handDrag.card]);
