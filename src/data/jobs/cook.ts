...
export const COOK_UNCOMMON_POOL: Card[] = [
  ...
  { id: 'delivery', name: '出前配達', type: 'attack', timeCost: 2, description: 'ランダム敵に4ダメージ×3回', damage: 4, icon: '🛵', sellValue: 12, imageUrl: deliveryBikeImage },
  { id: 'simmering', name: '煮込み', type: 'skill', timeCost: 2, description: '調理+3、HP5回復', icon: '🍲', tags: ['ingredient'], effects: [{ type: 'cooking_gauge', value: 3 }, { type: 'heal', value: 5 }], sellValue: 12, imageUrl: simmeringPotImage },
  {
...
export const COOK_RARE_POOL: Card[] = [
  { id: 'full_course', name: 'フルコース', type: 'attack', timeCost: 5, description: '調理ゲージ×6ダメージ', damage: 0, icon: '🍽️', tags: ['cooking'], cookingMultiplier: 6, rarity: 'rare', sellValue: 25, imageUrl: fullCourseImage },
  ...
  { id: 'flame_flambe', name: '炎のフランベ', type: 'attack', timeCost: 4, description: '12ダメージ+調理×4。全体攻撃', damage: 12, icon: '🔥', tags: ['cooking'], cookingMultiplier: 4, rarity: 'rare', sellValue: 25, imageUrl: flameFlambe2Image },
];
