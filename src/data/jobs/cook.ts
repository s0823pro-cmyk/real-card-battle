...
export const COOK_STARTER_DECK: Card[] = [
  { id: 'knife_1', name: '包丁さばき', type: 'attack', timeCost: 2, description: '4ダメージ', damage: 4, icon: '🔪', sellValue: 5, imageUrl: knifeSkillImage },
  { id: 'knife_2', name: '包丁さばき', type: 'attack', timeCost: 2, description: '4ダメージ', damage: 4, icon: '🔪', sellValue: 5, imageUrl: knifeSkillImage },
  { id: 'knife_3', name: '包丁さばき', type: 'attack', timeCost: 2, description: '4ダメージ', damage: 4, icon: '🔪', sellValue: 5, imageUrl: knifeSkillImage },
  { id: 'knife_4', name: '包丁さばき', type: 'attack', timeCost: 2, description: '4ダメージ', damage: 4, icon: '🔪', sellValue: 5, imageUrl: knifeSkillImage },
  ...
  { id: 'onion', name: '玉ねぎを切る', type: 'attack', timeCost: 1, description: '3ダメージ、調理+1', damage: 3, icon: '🧅', sellValue: 5, tags: ['ingredient'], effects: [{ type: 'cooking_gauge', value: 1 }], imageUrl: onionCutImage },
  {
    id: 'flambe',
    name: 'フランベ',
    type: 'attack',
...
export const COOK_COMMON_POOL: Card[] = [
  { id: 'garlic', name: 'にんにく投げ', type: 'attack', timeCost: 1, description: '3ダメージ、弱体付与、調理+1', damage: 3, icon: '🧄', tags: ['ingredient'], effects: [{ type: 'cooking_gauge', value: 1 }, { type: 'debuff_enemy', value: 1 }], sellValue: 5, imageUrl: garlicThrowImage },
  { id: 'frypan', name: '鉄のフライパン', type: 'attack', timeCost: 2, description: '6ダメージ', damage: 6, icon: '🍳', sellValue: 5, imageUrl: ironPanImage },
  { id: 'cutting_board', name: 'まな板ガード', type: 'skill', timeCost: 2, description: '5ブロック、次の食材+3ダメージ', block: 5, icon: '🪵', sellValue: 5, imageUrl: cuttingBoardGuardImage },
  { id: 'meat', name: '肉を叩く', type: 'attack', timeCost: 2, description: '5ダメージ、調理+2', damage: 5, icon: '🥩', tags: ['ingredient'], effects: [{ type: 'cooking_gauge', value: 2 }], sellValue: 5, imageUrl: meatPoundImage },
  { id: 'salt', name: '塩コショウ', type: 'skill', timeCost: 1, description: '敵に脆弱2付与、調理+1', icon: '🧂', tags: ['ingredient'], effects: [{ type: 'cooking_gauge', value: 1 }, { type: 'vulnerable', value: 2 }], sellValue: 5, imageUrl: saltPepperImage },
  {
    ...
    type: 'skill',
    timeCost: 1,
    description: '次のアタックカード+3ダメージ、調理+1',
    icon: '🔪',
    sellValue: 5,
    tags: ['ingredient'],
    effects: [
...
export const COOK_UNCOMMON_POOL_UNFILTERED: Card[] = [
  ...
  { id: 'knife_set', name: '包丁セット', type: 'tool', timeCost: 4, description: '全アタック+2ダメージ', icon: '🔪', sellValue: 12, imageUrl: knifeSetImage },
  {
    ...
    reserveBonus: { description: '温存時：10ダメージ、調理+2', damageMultiplier: 2.0, extraEffects: [{ type: 'cooking_gauge', value: 2 }] },
    badges: ['reserve'],
    sellValue: 12,
...
export const COOK_RARE_POOL_UNFILTERED: Card[] = [
  ...
  { id: 'mystery_pot', name: '闇鍋', type: 'attack', timeCost: 3, description: 'ランダムで10〜25ダメージ', damage: 0, icon: '🫕', tags: ['cooking'], rarity: 'rare', sellValue: 25, imageUrl: mysteryPotImage },
  {
    id: 'flame_flambe',
    name: '炎のフランベ',
    type: 'attack',
    timeCost: 4,
    description: '8ダメージ+調理×4。全体攻撃',
    damage: 8,
    icon: '🔥',
